									...
									<div class="card-body">
										...
										<td>
											<?php if ($row['status'] == '1') { ?>
												...
												<a class="btn btn-warning btn-action mr-1" data-toggle="tooltip" title="Pasien keluar" data-confirm="Pasien Keluar|Apakah benar pasien yang bernama <b><?php echo ucwords($namapasien["nama_pasien"]) ?></b> akan keluar?" data-confirm-yes="window.location.href = 'updateriwayat.php?id=<?php echo $defpasien; ?>'" ;><i class="ion-log-out"></i></a>
											<?php } else { ?>
