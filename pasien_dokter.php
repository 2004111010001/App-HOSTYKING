                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
                      <a href="tindakan_dokter.php" class="btn btn-primary">Daftar pasien baru</a>
                    </div>
                    <div class="card-header-action">
                      <a href="pasien_book_dokter.php" class="btn btn-primary">Pasien yang telah booking</a>
                    </div>
                  </div>
                  <div class="card-body">
                            ...
                            <tr>
                              ...
                              <td align="center">
                                <form method="POST" action="detail_pasien_dokter.php">
                                  ...
                                  <a class="btn btn-danger btn-action mr-1" data-toggle="tooltip" title="Hapus" data-confirm="Hapus Data|Apakah anda ingin menghapus data ini?" data-confirm-yes="window.location.href = 'auth/delete_dokter.php?type=pasien&id=<?php echo $row['id']; ?>'" ;><i class="fas fa-trash"></i></a>
                                  <input type="hidden" name="id" value="<?php echo $row['nama_pasien']; ?>">
