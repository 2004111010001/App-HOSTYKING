                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
                      <a href="pasien_book_apoteker.php" class="btn btn-primary">Pasien yang telah booking</a>
                    </div>
                  </div>
                  <div class="card-body">
                            ...
                            <tr>
                              ...
                              <th><?php echo ucwords($row['nama_pasien']); ?>
                                <div class="table-links">
                                  ...
                                  if ($cekrekam == 0) {
                                    ...
                                    <form method="POST" action="detail_pasien_apoteker.php">
                              ...
                              <td align="center">
                                <form method="POST" action="detail_pasien_apoteker.php">
                                  ...
                                  <a class="btn btn-danger btn-action mr-1" data-toggle="tooltip" title="Hapus" data-confirm="Hapus Data|Apakah anda ingin menghapus data ini?" data-confirm-yes="window.location.href = 'auth/delete_apoteker.php?type=pasien&id=<?php echo $row['id']; ?>'" ;><i class="fas fa-trash"></i></a>
                                  <input type="hidden" name="id" value="<?php echo $row['nama_pasien']; ?>">
